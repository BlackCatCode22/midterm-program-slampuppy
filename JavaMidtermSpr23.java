...
{   static String calcBirthdate(int yearsOld, String birthSeason) {
    ...
    {
        System.out.println("\n\nWelcome to Derrick's Zoo program!\n\n");
        ...
        try
        {
            File myAnimalsFile = new
                    File("/Users/ricky/Desktop/CppZoo/arrivingAnimals.txt");
            Scanner scanner = new Scanner(myAnimalsFile);
            System.out.println("\n The arrivingAnimals.text file...\n");
        ...
        String tigerNames[] = {"Tony", "Tigger", "Amber", "Cosimia", "Cuddles", "Dave", "Jiba", "Rayas", "Ryker"};
        ...
        try
        {
            FileWriter file = new FileWriter("/Users/ricky/Desktop/midtermProgram/javaOutputFile.txt");
